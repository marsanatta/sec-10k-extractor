...
def _no_copilot_token(monkeypatch):
    ...
    regardless of the developer's shell. The enable flag is cleared too so the tier stays OFF."""
    for var in ("COPILOT_GITHUB_TOKEN", "GH_TOKEN", "GITHUB_TOKEN", "SEC10K_LLM_ESCALATION"):

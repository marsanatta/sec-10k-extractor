...
Run: 2026-06-24 22:24 Asia/Taipei. On-demand EDGAR batch (accession-pinned); NOT part of the offline unit
...
| jpm-fy2023 | ixbrl | large_accelerated | finance | broken_text_source | 22 | 4/4 | regex | 1.0 | - |  | edgartools .text() returned a repr stub; recovered by html-fallback source |

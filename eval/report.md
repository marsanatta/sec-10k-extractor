...
- **Boundary match-rate @ IoU>=0.9 vs INDEPENDENT gold: 0.75 over 4 gold filings** (a wrong boundary shows up here as a number)
...
| m2i-fy2023 | ixbrl | 0 | 0.0 | 0.0 (0/2) | False | True | 0/0 |
